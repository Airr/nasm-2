...
; Build: see makefile
; Run:   ./besiscard n
;        n is a Belgian 10 digit siscard number.
; Description:
;        Modulo 97 check on siscard number.
...
section .data
        ...
        msgUsage:       db  "usage: besiscard n",10,"n = 10 digit Belgian siscard number",10
        .length:        equ $-msgUsage
        msgResult:      db  "illegal siscard number", 10
...
.ascii:        
        ...
        add     rdx, rax
        cmp     rcx, 1                  ; last digit of siscard number?
        je      .done                   ; yes
...
.done:
        ...
        cmp     rax, rcx
        jne     .isnotequal
        inc     rsi                     ; adjust pointer to message
        inc     rsi
        dec     rdx                     ; adjust message length
        dec     rdx
.isnotequal:
        jmp     .write
.usage:        
