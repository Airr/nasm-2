...
; Build: see makefile
; Run:   ./structmsg n
;        n is a 12 digit structured message.
; Description:
;        Modulo 97 check on structured message.
...
section .data
        ...
        msgUsage:       db  "usage: structmsg n",10,"n = 12 digit structured message",10
        .length:        equ $-msgUsage
        msgResult:      db  "illegal structured message", 10
...
.ascii:        
        ...
        add     rdx, rax
        cmp     rcx, 1                  ; last digit of structured message?
        je      .done                   ; yes
